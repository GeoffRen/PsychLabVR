...
{	
	...
	void SetVisemeToMorphTarget()
	{
		...
		{
            //For debugging out of range exception
            //Debug.Log("VisemeToBlendTargets.Length = " + VisemeToBlendTargets.Length);
            //Debug.Log("frame.Visemes.Length = " + frame.Visemes.Length);
